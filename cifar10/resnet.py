...
class ResNet20(nn.Module):
    def __init__(self, in_size=32, in_channels=3, classes=10, activation="relu", norm="batch_static", dropout_p=None, variational=False, prior=None, rank1=False, components=1):
        super().__init__()
