...
class FixableDropout(nn.Module):
    ...
    def __init__(self, p, freeze_on_eval=False):
        super().__init__()
...
class ResNet18(nn.Module):
    def __init__(self, in_size=224, in_channels=8, classes=1, activation="relu", norm="batch_static", dropout_p=None, variational=False, rank1=False, prior=None, components=1):
        super().__init__()
        self.model = nn.Sequential(
