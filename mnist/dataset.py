...
class RotatedMNIST(MNIST):
    def __init__(self, root, train=True, transform=None, target_transform=None, download=False, angle=0):
        self.angle = angle
        transform = transforms.Compose([RotationTransform(angle), transforms.ToTensor(), transforms.Normalize((0.1307,), (0.3081,))])
